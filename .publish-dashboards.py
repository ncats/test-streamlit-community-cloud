...
FOUNDRY_ARTIFACTS_API = get_environment_variable("FOUNDRY_ARTIFACTS_API")
...
def publish_dashboard(dashboard_rid, dashboard_definition):
    ...
    runtime = {
        ...
        for key in ["idleTimeout", "resourceProfile", "resources", "inputs", "networkPolicies", "environmentVariables", "shared"]
    }
    payload = {
        "branch": BRANCH,
